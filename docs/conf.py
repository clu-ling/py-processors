# -*- coding: utf-8 -*-
#
# py-processors documentation build configuration file, created by
# sphinx-quickstart on Sun Jun 12 22:15:38 2016.
#
...
version = processors.__version__
# The full version, including alpha/beta/rc tagss
release = processors.__version__
...
htmlhelp_basename = 'py-processorsdoc'
...
latex_documents = [
  (master_doc, 'py-processors.tex', u'py-processors Documentation',
   u'Gus Hahn-Powell', 'manual'),
]
